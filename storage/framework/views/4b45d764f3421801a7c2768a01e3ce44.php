...
<?php $component->withAttributes([]); ?>
    <div class="w w-96 border mx-auto p-8 mb-10">
...
<?php endif; ?>
        ...
        <div class="mt-4">
            <div class="flex">
                <input type="radio" name="role" value="user"class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="user">
                <label for="user" class="text-sm text-gray-500 ms-2 dark:text-gray-400">user</label>
              </div>
              
              <div class="flex">
                <input type="radio" name="role" value="admin" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="admin" checked>
                <label for="admin" class="text-sm text-gray-500 ms-2 dark:text-gray-400">Admin</label>
              </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\rivar\laundryshoes\resources\views/auth/register.blade.php ENDPATH**/ ?>